						...
						<form class="mdl-formulario text-left">
		    				...
		    				<div class="col-sm-6 js-checkbox js-terminos">
                                <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-1">
                                    ...
                                    <span class="mdl-checkbox__label" style=""> <a href="http://www.sap-latam.com/5reasons_hana/public/pdf/SAP_Privacy_Statement_Top5_Reasons_Es.pdf" target="_blank">T&eacute;rminos y condiciones</a></span>
                                </label>
                            </div>
                            <div class="col-sm-6 js-checkbox js-terminos">
