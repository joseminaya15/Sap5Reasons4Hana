		...
		<div id="window4">
			...
			<div class="mdl-agradecimiento window-center opacity-done">
				<div class="center-container">
					...
					<small>Conheça o Caso de Sucesso de uma empresa de <strong class="nameIndustria"></strong>. Faça o download <a id="donwloadCaso" href="#" onclick="returnCaso()">aqui</a></small>
				</div>
			</div>
		</div>
	</section>
